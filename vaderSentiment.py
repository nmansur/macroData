...
# booster/dampener 'intensifiers' or 'degree adverbs'<br>
...
# import os, random, time ,numpy, sys, spacy, re

# #processing file Name 
# fileName =""
# #Load Data from the processed files finanancial and news transacripts 
# def load_data(data,label):
#     for file in os.listdir(label):
#         if file.endswith(".txt") and not file.startswith("."):
#             file_path = label + '/'+file
#             #Take the file name out as global variable 
#             global fileName
#             fileName =file.lower()
#             qtr =(fileName.split('_',1)[1]).split('.txt',1)[0]
...
# # Data dictionary to hold the processed file.
# data ={}
...
# default_corpus = textacy.Corpus(en, data)

# from nltk.tokenize import sent_tokenize
# a_list = sent_tokenize(default_corpus[0].text)
# print(len(a_list))
# #print(a_list)
...
# df_score = pd.DataFrame(sentence_dict).transpose()
...
# df_score.head(40).style.set_properties(**{'text-align': 'left'})


# # In[23]:


# df_score.to_excel(dataFolder+ '/reports/'+fileName+'_sentiment_score.xlsx')
